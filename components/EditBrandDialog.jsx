...
export default function EditBrandDialog({ show, onConfirm, onCancel, brandData }) {
  const { t } = useLanguage();
    ...
    >
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '24px' }}>
          ...
          <h3 style={{ margin: '0 0 8px 0' }}>{t('editBrand') || 'Edit Brand'}</h3>

...
export default function AddGroupDialog({ show, onConfirm, onCancel, brandName }) {
  const { t } = useLanguage();
  const [formData, setFormData] = useState({
    ...
    tagline: '',
    logo: '',
    logoType: 'builtin' // 'builtin' or 'custom'
  });
    ...
    >
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '24px' }}>
          ...
          <h3 style={{ margin: '0 0 8px 0' }}>{t('addNewGroup') || 'Add New Group'}</h3>
